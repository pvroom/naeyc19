...
import { /*Modal,*/ ModalController, NavController, LoadingController, AlertController, Events, IonContent } from '@ionic/angular';
...
@Component({
  selector: 'app-activityfeeddetails',
  templateUrl: './activityfeeddetails.page.html',
  styleUrls: ['./activityfeeddetails.page.scss'],
