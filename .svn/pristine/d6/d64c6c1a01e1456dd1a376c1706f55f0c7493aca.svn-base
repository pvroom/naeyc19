				...
				this.databaseprovider.getSpeakerData(flags, "0").then(data2 => {
					...
					if (data2['length']>0) {
						...
						for (var i = 0; i < data2['length']; i++) {
							...
							var sessionHeader = "<h5> <b>" + data2[i].session_title + "</b></h5><p>" + DisplayDateTime + " in " + data2[i].RoomName + "</p>";
					...
					console.log('Speaker Details: Finished loading sessions for this speaker.');
